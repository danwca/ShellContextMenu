...
It adds the menu item "Display File Name (VB)" with icon to the context menu 
when you right-click a .vb file in the Windows Explorer. Clicking the menu 
item brings up a message box that displays the full path of the .vb file.
...
(VB)" menu item with icon in the context menu and a menu seperator below it. 
...
registered.
  ...
  In this code sample, we insert the menu item "Display File Name (VB)" with 
